...
[AMP](https://amp.dev) is a web component framework that makes it easy to create user-friendly websites, stories, ads, emails, and more.

AMP is an open-source project, and we welcome your help to improve it!
...
-   The [amp.dev Support page](https://amp.dev/support/) offers resources to help you get assistance.
-   Use [Stack Overflow](http://stackoverflow.com/questions/tagged/amp-html) to ask questions about using AMP and to find answers to questions others have asked.
...
-   [docs/contributing.md](https://github.com/ampproject/amphtml/blob/main/docs/contributing.md) provides information on how you can help improve AMP. It includes details about [ongoing participation](https://github.com/ampproject/amphtml/blob/main/docs/contributing.md#ongoing-participation) through Slack and weekly design reviews.
-   We strongly encourage [code contributions](https://github.com/ampproject/amphtml/blob/main/docs/contributing-code.md)!
-   **We enthusiastically welcome new contributors to AMP _even if you have no experience with open source projects_**. We've made it easy to [get started contributing](https://github.com/ampproject/amphtml/blob/main/docs/contributing.md#get-started-with-open-source).
-   Consider joining one of AMP's [Working Groups](https://github.com/ampproject/meta/tree/main/working-groups), where most of the daily work in AMP is done.

## Other useful information

-   The [AMP's release documentation](docs/release-schedule.md) explains how and when AMP releases new versions, including [how to know when a change is live in a release](https://github.com/ampproject/amphtml/blob/main/docs/release-schedule.md#determining-if-your-change-is-in-a-release).
-   The [AMP's roadmap](https://amp.dev/community/roadmap) outlines some of the major projects we are working on.
-   The [AMP meta repository](https://github.com/ampproject/meta) contains information _about_ the AMP open source project, including AMP's [governance](https://github.com/ampproject/meta/blob/main/GOVERNANCE.md).
-   The [AMP's code of conduct](https://github.com/ampproject/meta/blob/main/CODE_OF_CONDUCT.md) describes how all members, committers and volunteers in the community should behave. AMP aims to foster a positive and growing community that provides a safe environment for everyone.
